/**
 * Queries owned by the hymns module.
 *
 * @module modules/hymns/queries
 */
...
export * from "./listHymns/index.js";
export * from "./listHymnsForVerse/index.js";
export * from "./listTopics/index.js";
export * from "./searchHymns/index.js";
